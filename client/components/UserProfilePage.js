      ...
      <div className="profile_box">
        ...
        <div>
          ...
          <div>
            <Route
              path="/profile/edit"
              render={() => <EditProfile user={this.props.user} />}
            />
            <Route
              path="/profile/address"
              render={() => <AddressForm user={this.props.user} />}
            />
            <Route
              path="/profile/payment"
              render={() => <PaymentForm user={this.props.user} />}
            />
            <Route
              path="/profile/history"
              render={() => <OrderHistory user={this.props.user} />}
            />
          </div>
        </div>
      </div>
